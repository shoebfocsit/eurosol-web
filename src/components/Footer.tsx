        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Powering India's future with premium European solar technology. Your trusted partner for clean, sustainable energy solutions in Madhya Pradesh & Maharashtra.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Custom System Design", href: "/services/custom-design" },
                { label: "Net Metering", href: "/services/net-metering" },
                { label: "Subsidy Assistance", href: "/services/subsidy-assistance" },
                { label: "Commercial Solar", href: "/services/commercial-solar" },
              ].map((s) => (
                <li key={s.label}>
                  <Link to={s.href} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    {s.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-12 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} Eurosol Prime. All rights reserved.
            </p>
